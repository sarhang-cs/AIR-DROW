...
const required = [
  ...
  "web/assets/js/features/device-readiness.js", "web/assets/js/features/final-live-qa.js", "web/assets/js/features/hand-calibration.js", "web/assets/js/features/hand-tracking-engine.js", "web/assets/js/features/hand-engine-bootstrap.js", "web/assets/js/features/onboarding-flow.js", "web/assets/js/features/exporter.js", "web/assets/js/features/stroke-smoother.js", "web/assets/js/features/gesture-shortcuts.js", "web/assets/js/features/ai-studio.js",
  "web/vendor/models/hand_landmarker.task", "scripts/build-selfhosted-mediapipe.mjs", "scripts/verify-final-release.mjs", "scripts/verify-localization-theme-final.mjs", "scripts/verify-runtime-experience.mjs", "web/assets/brand/instagram-sarhang-io-qr.svg", "docs/screenshots/air-drow-studio-en.png", "docs/screenshots/air-drow-hand-en.png", "scripts/verify-local-hand-model.mjs", "scripts/verify-hand-runtime-loader-fix.mjs", "scripts/verify-deployment-build-order.mjs", "scripts/verify-critical-input-export-recovery.mjs", "tests/export-gesture-reliability.test.mjs", "scripts/sync-toolbar-icons.mjs", "scripts/verify-toolbar-icon-bundle.mjs", "api/health.js", "api/ai/generate.js", ".env.example", "vercel.json", "package.json"
];
...
if (!manifest.name.includes("AIR-DROW") || !manifest.start_url.includes("v771")) throw new Error("Install manifest is missing the current release.");
if (!html.includes('production-ui.css?v=771')) throw new Error("Consolidated production stylesheet is not linked.");
