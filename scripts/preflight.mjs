...
if (!manifest.name.includes("AIR-DROW") || !manifest.start_url.includes("v800")) throw new Error("Install manifest is missing the current release.");
if (!html.includes('production-ui.css?v=800')) throw new Error("Consolidated production stylesheet is not linked.");
