...
if (statSync(resolve(root, "web/assets/fonts/noto-kufi-arabic/NotoKufiArabic-VariableFont_wght.ttf")).size < 100_000) throw new Error("Complete local Kurdish typography asset is missing.");
if (!html.includes("NotoKufiArabic-VariableFont_wght.ttf")) throw new Error("Local Kurdish font preload is missing.");
