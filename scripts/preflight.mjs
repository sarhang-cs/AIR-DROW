...
const required = [
  ...
  "scripts/build-selfhosted-mediapipe.mjs", "scripts/verify-bootstrap-pwa-recovery.mjs", "scripts/verify-code-cleanup.mjs", "scripts/verify-premium-visual-system.mjs", "scripts/sync-toolbar-icons.mjs", "scripts/verify-toolbar-icon-bundle.mjs", "scripts/verify-update-runtime.mjs", "scripts/verify-smart-shape.mjs", "scripts/verify-workspace-navigation.mjs", "scripts/verify-loading-experience.mjs", "scripts/verify-performance-guard.mjs", "scripts/verify-hand-calibration.mjs", "scripts/verify-hand-tracking-runtime.mjs", "scripts/verify-export-save-onboarding.mjs", "scripts/verify-final-completion-pass.mjs", "web/assets/css/icon-system.css", "web/assets/icons/ICON_SYSTEM.md",
