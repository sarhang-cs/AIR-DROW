...
const required = [
  "web/index.html", "web/assets/css/app.css", "web/assets/css/phase2-ui.css", "web/assets/css/ui-clarity.css", "web/assets/css/final-layout-localization.css", "web/release.json", "web/sw.js", "web/manifest.webmanifest", "web/favicon.svg", "web/assets/fonts/noto-kufi-arabic/NotoKufiArabic-VariableFont_wght.ttf",
  ...
  "web/vendor/models/hand_landmarker.task", "scripts/build-selfhosted-mediapipe.mjs", "scripts/verify-final-release.mjs", "scripts/verify-final-layout-localization.mjs", "scripts/verify-ui-clarity.mjs", "scripts/verify-local-hand-model.mjs", "scripts/verify-hand-runtime-loader-fix.mjs", "scripts/verify-deployment-build-order.mjs", "scripts/sync-toolbar-icons.mjs", "scripts/verify-toolbar-icon-bundle.mjs", "api/health.js", "api/ai/generate.js", ".env.example", "vercel.json", "package.json"
];
