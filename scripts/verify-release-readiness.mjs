...
const required = ["docs/DEVICE_VALIDATION_CHECKLIST.md", "docs/DEVICE_VALIDATION_CHECKLIST_KU.md", "docs/V820_VISUAL_GUIDANCE_PERSISTENCE.md", "docs/V820_VISUAL_GUIDANCE_PERSISTENCE_KU.md"];
