...
if (!html.includes('href="./assets/css/icon-system.css?v=506"')) throw new Error("Icon system CSS is not linked.");
...
if (release.version !== "5.0.6" || release.buildId !== "air-drow-v506-hand-runtime-loader-fix") throw new Error("Completion-pass version metadata is inconsistent.");
