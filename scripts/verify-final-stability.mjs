...
if (release.version !== "5.2.3" || release.buildId !== "air-drow-v523-release-verification-recovery-fix") throw new Error("Release metadata is invalid.");
if (packageJson.version !== "5.2.3") throw new Error("Package metadata is invalid.");
