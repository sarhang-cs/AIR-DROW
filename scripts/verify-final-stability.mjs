...
if (release.version !== "5.2.1" || release.buildId !== "air-drow-v521-transparent-status-hud-fix") throw new Error("Release metadata is invalid.");
if (packageJson.version !== "5.2.1") throw new Error("Package metadata is invalid.");
