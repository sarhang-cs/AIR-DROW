...
if (release.version !== "5.1.0" || release.buildId !== "air-drow-v510-bootstrap-pwa-recovery-fix") throw new Error("Release metadata is invalid.");
if (packageJson.version !== "5.1.0" || packageJson.engines?.node !== ">=22") throw new Error("Package metadata is invalid.");
