...
if (release.version !== "5.0.6" || release.buildId !== "air-drow-v506-hand-runtime-loader-fix") throw new Error("Release metadata is invalid.");
if (packageJson.version !== "5.0.6" || packageJson.engines?.node !== "24.x") throw new Error("Package metadata is invalid.");
