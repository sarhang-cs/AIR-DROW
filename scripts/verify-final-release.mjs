...
const required = [
  ...
  "termux/replace-with-v820-visual-guidance-persistence.sh",
  "docs/screenshots/air-drow-studio-en.png", "docs/screenshots/air-drow-hand-en.png",
  "docs/V820_VISUAL_GUIDANCE_PERSISTENCE.md", "docs/V820_VISUAL_GUIDANCE_PERSISTENCE_KU.md", "docs/V820_QA_REPORT.md",
...
if (release.assetRevision !== assets.assetRevision || release.assetRevision !== "820") throw new Error("Asset revision metadata is not synchronized.");
...
if (!read("README.md").includes("docs/screenshots/air-drow-studio-en.png") || !read("README_KU.md").includes("docs/screenshots/air-drow-hand-en.png") || !read("README.md").includes("v8.2.0")) throw new Error("README screenshots or current release notes are not linked.");
...
if (!index.includes("production-ui.css?v=820") || !worker.includes("production-ui.css?v=820")) throw new Error("Current static cache revision is not synchronized.");
