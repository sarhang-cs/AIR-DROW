...
if (!index.includes("about-creator-card") || !index.includes("instagram-sarhang-io-qr.svg") || !index.includes("https://www.instagram.com/sarhang.io/")) throw new Error("Developer profile or Instagram QR markup is incomplete.");
...
if (!read("web/assets/css/visual-system.css").includes("icon contrast contract")) throw new Error("Theme icon contrast system is missing.");
