...
if (modelManifest.bytes !== 7820242 || modelManifest.sha256 !== "168ca8a3f698e93e2caba5c5e8234c3443e56b2ea3ebacec205e4df33bc899da") throw new Error("Model manifest integrity values are inconsistent.");
...
if (read("scripts/build-selfhosted-mediapipe.mjs").includes("storage.googleapis.com")) throw new Error("Build must not fetch the hand model from the network.");
...
console.log(`AIR-DROW fully local release verified: v${version} / ${buildId}`);
