...
if (release.assetRevision !== assets.assetRevision || release.assetRevision !== "840") throw new Error("Asset revision metadata is not synchronized.");
...
if (!read("README.md").includes("docs/screenshots/air-drow-studio-en.png") || !read("README_KU.md").includes("docs/screenshots/air-drow-hand-en.png") || !read("README.md").includes("v8.4.0")) throw new Error("README screenshots or current release notes are not linked.");
...
if (!index.includes("production-ui.css?v=840") || !worker.includes("production-ui.css?v=840")) throw new Error("Current static cache revision is not synchronized.");
