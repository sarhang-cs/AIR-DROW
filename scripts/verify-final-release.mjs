...
if (release.assetRevision !== assets.assetRevision || release.assetRevision !== "756") throw new Error("Asset revision metadata is not synchronized.");
