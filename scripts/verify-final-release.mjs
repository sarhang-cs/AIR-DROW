...
const required = [
  ...
  "termux/replace-with-v810-on-device-launch-validation.sh",
  "docs/screenshots/air-drow-studio-en.png", "docs/screenshots/air-drow-hand-en.png",
  "docs/V810_ON_DEVICE_VALIDATION.md", "docs/V810_ON_DEVICE_VALIDATION_KU.md",
...
if (release.assetRevision !== assets.assetRevision || release.assetRevision !== "810") throw new Error("Asset revision metadata is not synchronized.");
...
if (!read("README.md").includes("docs/screenshots/air-drow-studio-en.png") || !read("README_KU.md").includes("docs/screenshots/air-drow-hand-en.png") || !read("README.md").includes("v8.1.0")) throw new Error("README screenshots or current release notes are not linked.");
...
if (!index.includes("production-ui.css?v=810") || !worker.includes("production-ui.css?v=810")) throw new Error("Current static cache revision is not synchronized.");
