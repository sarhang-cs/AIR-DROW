...
const localKurdishFont = resolve(root, "web/assets/fonts/noto-kufi-arabic/NotoKufiArabic-VariableFont_wght.ttf");
const required = [
  ...
  "termux/replace-with-v870-final-release-font-restoration.sh",
  "docs/V870_FINAL_RELEASE_FONT_RESTORATION.md", "docs/V870_FINAL_RELEASE_FONT_RESTORATION_KU.md", "docs/V870_QA_REPORT.md",
  "scripts/verify-kurdish-font-restore.mjs", "scripts/verify-kurdish-font-build-output.mjs", "tests/kurdish-font-restore.test.mjs",
  "web/assets/fonts/noto-kufi-arabic/NotoKufiArabic-VariableFont_wght.ttf",
  "docs/screenshots/air-drow-studio-en.png", "docs/screenshots/air-drow-hand-en.png",
  "docs/V830_EXPORT_PREVIEW_SAVE_POLISH.md", "docs/V830_EXPORT_PREVIEW_SAVE_POLISH_KU.md", "docs/V830_QA_REPORT.md", "docs/V831_QA_REPORT.md", "docs/V831_LEGACY_WEBKIT_COMPATIBILITY.md", "docs/V831_LEGACY_WEBKIT_COMPATIBILITY_KU.md", "docs/V832_LAYOUT_LEGACY_RUNTIME_HARDENING.md", "docs/V832_LAYOUT_LEGACY_RUNTIME_HARDENING_KU.md", "docs/V832_QA_REPORT.md", "docs/V840_HAND_INPUT_RELIABILITY.md", "docs/V840_HAND_INPUT_RELIABILITY_KU.md", "docs/V840_QA_REPORT.md", "docs/V850_SETTINGS_KURDISH_RESPONSIVE_POLISH.md", "docs/V850_SETTINGS_KURDISH_RESPONSIVE_POLISH_KU.md", "docs/V850_QA_REPORT.md", "docs/V870_FINAL_RELEASE_FONT_RESTORATION.md", "docs/V870_FINAL_RELEASE_FONT_RESTORATION_KU.md", "docs/V870_QA_REPORT.md",
...
if (release.assetRevision !== assets.assetRevision || release.assetRevision !== "870") throw new Error("Asset revision metadata is not synchronized.");
...
if (!existsSync(localKurdishFont) || statSync(localKurdishFont).size < 100_000) throw new Error("Complete local Kurdish typography asset is missing.");
...
if (!read("README.md").includes("docs/screenshots/air-drow-studio-en.png") || !read("README_KU.md").includes("docs/screenshots/air-drow-hand-en.png") || !read("README.md").includes("v8.7.0")) throw new Error("README screenshots or current release notes are not linked.");
if (!read("web/assets/js/app.js").includes("createFeatureValidation") || !productionUi.includes("v8.7.0 Final Release + Font Restoration")) throw new Error("Final Release + Font Restoration is missing.");
...
if (!index.includes("production-ui.css?v=870") || !worker.includes("production-ui.css?v=870")) throw new Error("Current static cache revision is not synchronized.");
if (!index.includes("NotoKufiArabic-VariableFont_wght.ttf")) throw new Error("Local Kurdish font preload is missing.");
