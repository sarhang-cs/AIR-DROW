...
if (release.assetRevision !== assets.assetRevision || release.assetRevision !== "755") throw new Error("Asset revision metadata is not synchronized.");
