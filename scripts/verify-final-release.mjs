...
const required = [
  ...
  "termux/replace-with-v830-export-preview-save-polish.sh",
  "docs/screenshots/air-drow-studio-en.png", "docs/screenshots/air-drow-hand-en.png",
  "docs/V830_EXPORT_PREVIEW_SAVE_POLISH.md", "docs/V830_EXPORT_PREVIEW_SAVE_POLISH_KU.md", "docs/V830_QA_REPORT.md",
...
if (release.assetRevision !== assets.assetRevision || release.assetRevision !== "830") throw new Error("Asset revision metadata is not synchronized.");
...
if (!read("README.md").includes("docs/screenshots/air-drow-studio-en.png") || !read("README_KU.md").includes("docs/screenshots/air-drow-hand-en.png") || !read("README.md").includes("v8.3.0")) throw new Error("README screenshots or current release notes are not linked.");
...
if (!index.includes("production-ui.css?v=830") || !worker.includes("production-ui.css?v=830")) throw new Error("Current static cache revision is not synchronized.");
