...
if (release.assetRevision !== assets.assetRevision || release.assetRevision !== "850") throw new Error("Asset revision metadata is not synchronized.");
...
if (!read("README.md").includes("docs/screenshots/air-drow-studio-en.png") || !read("README_KU.md").includes("docs/screenshots/air-drow-hand-en.png") || !read("README.md").includes("v8.5.0")) throw new Error("README screenshots or current release notes are not linked.");
if (!read("web/assets/js/app.js").includes("openSettingsSection") || !productionUi.includes("v8.5.0 Settings + Kurdish Responsive Polish")) throw new Error("Settings/Kurdish responsive polish is missing.");
...
if (!index.includes("production-ui.css?v=850") || !worker.includes("production-ui.css?v=850")) throw new Error("Current static cache revision is not synchronized.");
