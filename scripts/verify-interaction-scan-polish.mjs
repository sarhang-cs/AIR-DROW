...
if (!css.includes("-webkit-user-select: none") || !css.includes("-webkit-tap-highlight-color: transparent")) throw new Error("Mobile selection and tap-highlight guards are incomplete.");
if (!app.includes("bindMobileInteractionGuards") || !app.includes("selectstart")) throw new Error("Android long-press guard is not installed.");
...
console.log(`AIR-DROW interaction/scan integrity passed: ${kuKeys.length} bilingual keys, selection lock, tap-highlight suppression and durable hand-check confirmation.`);
