...
for (const file of [
  ...
  "termux/replace-with-global-user-edition.sh"
...
if (!manifest.name.includes("AIR-DROW") || !manifest.start_url.includes("v710")) throw new Error("Install manifest is incomplete.");
...
for (const marker of ['"deviceReadinessTitle": "App Check"', '"finalLiveQaTitle": "Camera & Hand Check"', '"aboutMadeFor"', '"aboutPrivacy"']) {
