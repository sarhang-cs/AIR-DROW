...
assert.equal(release.version, "8.6.0");
assert.equal(release.assetRevision, "860");
assert.match(source, /assets\/css\/production-ui\.css\?v=860/);
...
assert.match(worker, /assets\/css\/production-ui\.css\?v=860/);
assert.match(manifest.start_url, /build=v860/);
