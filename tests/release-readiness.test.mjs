...
assert.equal(release.version, "8.3.0");
assert.equal(release.assetRevision, "830");
assert.match(source, /assets\/css\/production-ui\.css\?v=830/);
...
assert.match(worker, /assets\/css\/production-ui\.css\?v=830/);
assert.match(manifest.start_url, /build=v830/);
