...
assert.equal(release.version, "8.1.0");
assert.equal(release.assetRevision, "810");
assert.match(source, /assets\/css\/production-ui\.css\?v=810/);
assert.doesNotMatch(source, /(?:manifest|assets\/css|toolbar-icons)\.\w+(?:\?v=)(?:770|790|800)/);
...
assert.match(worker, /assets\/css\/production-ui\.css\?v=810/);
assert.match(manifest.start_url, /build=v810/);
