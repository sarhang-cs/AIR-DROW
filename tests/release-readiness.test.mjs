...
assert.equal(release.version, "8.4.0");
assert.equal(release.assetRevision, "840");
assert.match(source, /assets\/css\/production-ui\.css\?v=840/);
...
assert.match(worker, /assets\/css\/production-ui\.css\?v=840/);
assert.match(manifest.start_url, /build=v840/);
