...
assert.equal(release.version, "8.3.1");
assert.equal(release.assetRevision, "831");
assert.match(source, /assets\/css\/production-ui\.css\?v=831/);
...
assert.match(worker, /assets\/css\/production-ui\.css\?v=831/);
assert.match(manifest.start_url, /build=v831/);
