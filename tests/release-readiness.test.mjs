...
assert.equal(release.version, "8.2.0");
assert.equal(release.assetRevision, "820");
assert.match(source, /assets\/css\/production-ui\.css\?v=820/);
assert.doesNotMatch(source, /(?:manifest|assets\/css|toolbar-icons)\.\w+(?:\?v=)(?:770|790|800|810)/);
...
assert.match(worker, /assets\/css\/production-ui\.css\?v=820/);
assert.match(manifest.start_url, /build=v820/);
