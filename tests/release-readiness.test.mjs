...
assert.equal(release.version, "8.7.0");
assert.equal(release.assetRevision, "870");
assert.match(source, /assets\/css\/production-ui\.css\?v=870/);
...
assert.match(worker, /assets\/css\/production-ui\.css\?v=870/);
assert.match(manifest.start_url, /build=v870/);
