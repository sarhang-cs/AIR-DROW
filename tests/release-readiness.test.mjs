...
assert.equal(release.version, "8.5.0");
assert.equal(release.assetRevision, "850");
assert.match(source, /assets\/css\/production-ui\.css\?v=850/);
...
assert.match(worker, /assets\/css\/production-ui\.css\?v=850/);
assert.match(manifest.start_url, /build=v850/);
