...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "5.0.6", buildId: "air-drow-v506-hand-runtime-loader-fix" });
export const QUICK_START_KEY = "air-drow.v506.quick-start.complete";
...
export const PROFILE_RULES = Object.freeze({
  ...
  balanced: Object.freeze({ start: .31, stop: .47, smooth: .52, confidence: .56, enterFrames: 3, exitFrames: 3, stableFrames: 4, maxJump: .46, lostFrames: 4, minPalm: .036, minIndexReach: .38, minThumbReach: .12, maxTipDepth: 1.62, minIndexAngle: 22, minPalmAspect: .42, maxPalmAspect: 4.0, minFingerSpan: .42, minWristReach: .62 }),
  stable: Object.freeze({ start: .27, stop: .43, smooth: .62, confidence: .64, enterFrames: 4, exitFrames: 4, stableFrames: 5, maxJump: .36, lostFrames: 5, minPalm: .044, minIndexReach: .45, minThumbReach: .15, maxTipDepth: 1.38, minIndexAngle: 28, minPalmAspect: .50, maxPalmAspect: 3.5, minFingerSpan: .50, minWristReach: .70 })
});
