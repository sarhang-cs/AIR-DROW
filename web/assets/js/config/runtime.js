...
export const HAND_CALIBRATION_STORAGE_KEY = "air-drow.v754.hand-calibration";
...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v754-calibration-reality-qa", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "7.5.4", buildId: "air-drow-v754-calibration-reality-qa" });
export const QUICK_START_KEY = "air-drow.v754.quick-start.complete";
