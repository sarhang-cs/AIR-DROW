...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v760-final-clean-delivery", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "7.6.0", buildId: "air-drow-v760-final-clean-delivery" });
