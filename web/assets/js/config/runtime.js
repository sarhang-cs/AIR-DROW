...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v5-fbc2a300", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "5.2.3", buildId: "air-drow-v523-release-verification-recovery-fix" });
export const QUICK_START_KEY = "air-drow.v523.quick-start.complete";
