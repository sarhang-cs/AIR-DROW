...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v750-production-clean", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "7.5.0", buildId: "air-drow-v750-production-clean" });
export const QUICK_START_KEY = "air-drow.v750.quick-start.complete";
