...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v870-final-release-font-restoration", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "8.7.0", buildId: "air-drow-v870-final-release-font-restoration" });
