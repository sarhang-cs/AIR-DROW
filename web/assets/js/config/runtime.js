...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v832-layout-legacy-runtime-hardening", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "8.3.2", buildId: "air-drow-v832-layout-legacy-runtime-hardening" });
