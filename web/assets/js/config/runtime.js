...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v860-all-feature-device-qa", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "8.6.0", buildId: "air-drow-v860-all-feature-device-qa" });
