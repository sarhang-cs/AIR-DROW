...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v780-hand-performance-stabilization", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "7.8.0", buildId: "air-drow-v780-hand-performance-stabilization" });
...
export function createDefaultSettings() {
  return {
    ...
    showHandGuide: false, gestureShortcuts: false, inputSafetyVersion: 3, apiUrl: "", brushStyle: "classic", symmetry: 1, symmetryMirror: false, shapeAssist: true,
