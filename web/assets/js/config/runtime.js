...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v4-fbc2a300", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "5.2.0", buildId: "air-drow-v520-hand-sync-gpu-performance-fix" });
export const QUICK_START_KEY = "air-drow.v520.quick-start.complete";
