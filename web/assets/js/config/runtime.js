...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v761-interaction-vision-tutorial", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "7.6.1", buildId: "air-drow-v761-interaction-vision-tutorial" });
