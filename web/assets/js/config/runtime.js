...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v831-legacy-webkit-compatibility", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "8.3.1", buildId: "air-drow-v831-legacy-webkit-compatibility" });
