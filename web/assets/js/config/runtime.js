...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v790-mobile-safety-final-qa", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "7.9.0", buildId: "air-drow-v790-mobile-safety-final-qa" });
