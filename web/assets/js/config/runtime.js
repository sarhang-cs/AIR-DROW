...
export const HAND_MODEL = new URL("../../../vendor/models/hand_landmarker.task?model=v751-bootstrap-hotfix", import.meta.url).href;

export const APP_RELEASE = Object.freeze({ version: "7.5.1", buildId: "air-drow-v751-bootstrap-hotfix" });
export const QUICK_START_KEY = "air-drow.v751.quick-start.complete";
