# جێگۆڕکردنی پارێزراوی AIR-DROW v5.0.6 لە Termux

زیپی `AIR-DROW_v5.0.6_DRAWER_RTL_RELIABILITY.zip` بخە ناو Download ـی مۆبایل. مۆدێلی دەست و MediaPipe runtime لە خۆی زیپەکەدان؛ هیچ فایلێکی دیکە زیاد مەکە.
...
unzip -o AIR-DROW_v5.0.6_DRAWER_RTL_RELIABILITY.zip -d "$HOME/.airdrow-release-staging"
bash "$HOME/.airdrow-release-staging/AIR-DROW-v5.0.6-DRAWER-RTL-RELIABILITY/termux/replace-with-final-release.sh"
```
