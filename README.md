...
**SARHANG IO · 2026 · 7.5.2 Runtime & Storage Reliability Hotfix Edition**
...
- **Fresh release identity:** the build ID, asset query revision and PWA start URL changed to `v752`, forcing the browser to request the corrected startup files after deployment.
