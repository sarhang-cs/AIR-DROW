...
**SARHANG IO · 2026 · 7.5.3 Interaction & Hand Scan Polish Edition**
...
- **Fresh release identity:** the build ID, asset query revision and PWA start URL changed to `v753`, forcing the browser to request the corrected startup files after deployment.
