...
**Export Preview & Save Polish Edition · v8.3.0 · Created by Sarhang Salah**
...
Before tagging a live deployment, run the in-app App readiness check and complete the [Android Device Validation Checklist](./docs/DEVICE_VALIDATION_CHECKLIST.md). See [Visual Guidance & Persistent Settings](./docs/V830_EXPORT_PREVIEW_SAVE_POLISH.md) for the exact boundary between browser checks and physical-device checks. It is intentionally separate from automated checks because only a real phone can confirm its camera driver, permission prompt and browser download sheet.
...
## v8.3.0 on-device launch validation
...
## v8.3.0 — Visual Guidance & Persistent Settings
...
See [`docs/V830_EXPORT_PREVIEW_SAVE_POLISH.md`](docs/V830_EXPORT_PREVIEW_SAVE_POLISH.md).
